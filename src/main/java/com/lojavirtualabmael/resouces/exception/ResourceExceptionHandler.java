package com.lojavirtualabmael.resouces.exception;
...
import com.lojavirtualabmael.service.exception.FileException;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> ObjectNotFountException(ObjectNotFoundException e,HttpServletRequest request) {
	...
	public ResponseEntity<StandardError> file(FileException e, HttpServletRequest request) {
		...
		StandardError err = new StandardError(System.currentTimeMillis(), HttpStatus.BAD_REQUEST.value(), "Error de arquivo", e.getMessage(), request.getRequestURI());
